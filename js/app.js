...
function animateMenu(menu, trigger_anchor, anchor_page, trigger_nenu) {
	...
	var $links = $('' + menu + ' .nav__item a[href^="#"]');
	...
	var $win = $(window);
	var $download__btn = $('.header__row a[href^="popup-download"]');
	var $popup__download = $('#popup-download');
	var tooglemenu = true;
	//active menu
...
SliderBox = (function() {
  ...
  SliderBox.prototype.init = function(selector, options) {
    ...
    this.triggerPopup = this.el.find(this.props.triggerPopup);
  ...
  SliderBox.prototype.scrollSlider = function(progress) {
    var i, j, ref, results;
    results = [];
    for (i = j = 1, ref = this.count + 1; 1 <= ref ? j < ref : j > ref; i = 1 <= ref ? ++j : --j) {
      if (progress > ((i - 1) / this.count) && progress < (i / this.count)) {
        this.whichSlide = i;
        this.makeFade();
        results.push((function(_this) {
          return function(i) {
            return setTimeout(function() {
              return _this.sliderTrack.css({
                '-webkit-transform': 'translate(0,' + (-(i - 1)) * _this.heightSlide + 'px)',
                'transform': 'translate(0,' + (-(i - 1)) * _this.heightSlide + 'px)'
              });
            }, 250);
          };
        })(this)(i));
...
},{"./modal":4,"./scroll-controller":6}],8:[function(require,module,exports){
'use strict';
